...
export const PARTNERSHIP_BRANCHES: PartnershipBranch[] = [
  {
    id: 'rhapsody',
    name: 'partnerships.branch_rhapsody_name',
    description: 'partnerships.branch_rhapsody_desc',
    impact: 'partnerships.branch_rhapsody_impact',
    imageUrl: 'assets/rhapsody.png'
  },
  {
    id: 'hschool',
    name: 'partnerships.branch_hschool_name',
    description: 'partnerships.branch_hschool_desc',
    impact: 'partnerships.branch_hschool_impact',
    imageUrl: 'assets/healing-school.png'
  },
  {
    id: 'loveworld-tv',
    name: 'partnerships.branch_loveworld_name',
    description: 'partnerships.branch_loveworld_desc',
    impact: 'partnerships.branch_loveworld_impact',
    imageUrl: 'assets/loveworld-tv.png'
  },
  {
    id: 'innercity',
    name: 'partnerships.branch_innercity_name',
    description: 'partnerships.branch_innercity_desc',
    impact: 'partnerships.branch_innercity_impact',
    imageUrl: 'assets/inner-city.png'
  }
];
...
export const PAYMENT_METHODS = {
  angolan: [
    ...
    { id: 'bank', name: 'partnerships.method_bank', icon: '🏦' }
  ],
  international: [
...
export const COUNTRIES = [
  ...
  { name: 'Eswatini (Swaziland)', code: 'SZ', dialCode: '+268', flag: '🇸🇿' },
